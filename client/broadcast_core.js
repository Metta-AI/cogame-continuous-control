...
// here (the CTF_WIRE global becomes CC_WIRE) exactly as the design note
...
(function() {
  ...
  const CHROME_SPRITE_ID =
    (window.CC_WIRE && window.CC_WIRE.chromeSpriteId) || 4090;
  ...
  function BroadcastCore(config) {
    ...
    // in src/cc/sim.nim) and a packet is one such state. Drawn as-is that
