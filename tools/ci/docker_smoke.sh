...
# Substitute: continuous-control, coworld-continuous-control, 1.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-continuous-control:ci)
#   SMOKE_SLUG                 game slug                        (continuous-control)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/continuous-control)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/continuous-control-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-continuous-control:ci}}"
slug="${SMOKE_SLUG:-continuous-control}"
